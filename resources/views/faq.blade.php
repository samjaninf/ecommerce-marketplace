    ...
    <div class="container main-content-padded">
        ...
        <div class="row">
            <div class="col-xs-12 faq" style="font-weight: bold;">
                ...
                <p>Membership is £20 per month. No 12 month contracts. We may be running a promotion giving away free membership, be sure to check out what offers we have.</p>

                <h3>What is the commission rate?</h3>

                <p>Commission is 12% of the order total. All transaction fees are included within the 12%. No other hidden fees or costs.</p>

                <h3>Why 12%?</h3>

                <p>Our main aim is to bring you new customers. The commission is used to re-market your shop and to drive more customers through the door. Meaning that you keep 88% of sales you would otherwise not have made. Our commission rate includes all transaction fees and costs. We also expect that a lot of customers will use KoolBeans to discover coffee shops without ordering ahead. Another great reason to use KoolBeans as you keep 100% of those sales!</p>

                <h3>When do I get paid?</h3>

                <p>We transfer all payments owed to you every 30 days.</p>
                ...
                <p>If you are VAT registered you will pay the same VAT as you would if the sale came through your own till. KoolBeans is not VAT registered at the moment so no VAT is charged on the membership or commission. An itemised receipt is sent through each month so you can clearly see the VAT that is owed on the sales.</p>
                ...
                <p>It is easy to track the success of your KoolBeans account as all users that view your shop are displayed in your dashboard, this includes customers that haven’t ordered. This is advertising that you can really see the benefit of.</p>

                <h3>Why independent coffee shops?</h3>

                <p>It’s obvious to us that you take a huge amount of pride in serving the best coffee to your customers and we love that. KoolBeans aims to promote this to all that haven’t discovered this yet. We also want to help awesome coffee shops like you grow their customer base and grow as a community, raising the bar on the quality of the coffee we consume. For those that already use independents, KoolBeans will be a useful tool to find new shops, offering them the convenience of ordering ahead and the ability to grow the community with helpful, honest reviews</p>
 
                <h3>If I sign up am I entered into a lengthy contract?</h3>

                <p>We only offer monthly contracts. We are confident that you will be happy with our service. However in the unlikely event that you are not, you can leave at anytime.</p>
