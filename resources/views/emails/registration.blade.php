				...
				<![endif]-->
							...
							<tr>
								<td align="center" valign="top" id="templateBody">
									...
									<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
										<tr>
                                			<td valign="top" class="bodyContainer"><table class="mcnTextBlock" border="0" cellpadding="0" cellspacing="0" style="width: 600px; margin: 0 auto;">
    <tbody class="mcnTextBlockOuter">
        <tr>
            <td class="mcnTextBlockInner" valign="top">
                
                <table class="mcnTextContentContainer" align="left" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                    <tbody><tr>
                        
                        <td class="mcnTextContent" style="padding-top:0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px;" valign="top">
...
<table style="background-color: #000000;" class="mcnImageCardTopContent" align="right" border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody><tr>
        <td class="mcnTextContent" style="padding: 9px 0px 9px;color: #F2F2F2;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;" valign="top" width="600px">
            Check out our movie
        </td>
    </tr>
    <tr>
        <td class="mcnImageCardTopImageContent" style="padding-top:0px; padding-right:0px; padding-bottom:0px; padding-left:0px;" align="left" valign="top">
        
            
            <a href="https://youtu.be/rnXCgyNTpvQ" title="" class="" target="">
            

            <img alt="" src="https://gallery.mailchimp.com/video_thumbnails/13db58ed4ba96c9fb81fe160bb5e6fff.png" style="max-width:640px;" class="mcnImage" width="600">
                            ...
                            <tr>
								<td align="center" valign="top" id="templateFooter">
									...
									<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
										<tr>
                                			<td valign="top" class="footerContainer"><table class="mcnFollowBlock" style="min-width:100%;" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <![endif]-->
                                        ...
                                        <![endif]-->
                                            ...
                                            <table style="display:inline;" align="left" border="0" cellpadding="0" cellspacing="0">
                                                <tbody><tr>
                                                    <td style="padding-right:10px; padding-bottom:0px;" class="mcnFollowContentItemContainer" valign="top">
                                                                    ...
                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                        <tbody><tr>
                                                                                ...
                                                                                <td class="mcnFollowIconContent" align="center" valign="middle" width="24">
                                                                                    <a href="http://www.twitter.com/koolbeansuk" target="_blank"><img src="http://cdn-images.mailchimp.com/icons/social-block-v2/gray-twitter-48.png" style="display:block;" class="" height="24" width="24"></a>
                                                                                </td>
                                                                ...
                                                                <td style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;" align="left" valign="middle">
                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                        <tbody><tr>
                                                                                ...
                                                                                <td class="mcnFollowIconContent" align="center" valign="middle" width="24">
                                                                                    <a href="https://www.facebook.com/KoolBeansUK" target="_blank"><img src="http://cdn-images.mailchimp.com/icons/social-block-v2/gray-facebook-48.png" style="display:block;" class="" height="24" width="24"></a>
                                                                                </td>
                                                                ...
                                                                <td style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;" align="left" valign="middle">
                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                        <tbody><tr>
                                                                                ...
                                                                                <td class="mcnFollowIconContent" align="center" valign="middle" width="24">
                                                                                    <a href="http://koolbeans.co.uk/" target="_blank"><img src="http://cdn-images.mailchimp.com/icons/social-block-v2/gray-link-48.png" style="display:block;" class="" height="24" width="24"></a>
                                                                                </td>
                                                                ...
                                                                <td style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;" align="left" valign="middle">
                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                        <tbody><tr>
                                                                                ...
                                                                                <td class="mcnFollowIconContent" align="center" valign="middle" width="24">
                                                                                    <a href="https://www.youtube.com/channel/UC6qJcqUFdIPKiFrNaCXfoPQ?view_as=subscriber" target="_blank"><img src="http://cdn-images.mailchimp.com/icons/social-block-v2/gray-youtube-48.png" style="display:block;" class="" height="24" width="24"></a>
                                                                                </td>
                                                                ...
                                                                <td style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;" align="left" valign="middle">
                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                        <tbody><tr>
                                                                                ...
                                                                                <td class="mcnFollowIconContent" align="center" valign="middle" width="24">
                                                                                    <a href="mailto:info@koolbeans.co.uk" target="_blank"><img src="http://cdn-images.mailchimp.com/icons/social-block-v2/gray-forwardtofriend-48.png" style="display:block;" class="" height="24" width="24"></a>
                                                                                </td>
                ...
                <table style="min-width:100%;" class="mcnTextContentContainer" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tbody><tr>
                        ...
                        <td class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;" valign="top">
                            <em>Copyright © 2016 KoolBeans Ltd, All rights reserved.</em>
                        </td>
                    </tr>
                </tbody></table>
