...
@section('mail')
	                    ...
	                    <table class="mcnImageContentContainer" style="min-width:100%;" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
	                        <tbody><tr>
	                            <td class="mcnImageContent" style="padding-right: 0px; padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
	                                        ...
	                                        <img alt="" src="https://gallery.mailchimp.com/0703726b93d229eadd93c6ffc/images/0d7f41e1-dea7-4175-955c-5b894268fb93.png" style="max-width:940px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage" align="middle" width="600">
	...
	Hey {{ $user->name }},<br>
	<br>
	You've successfully registered with KoolBeans.<br>
	<br>
	Once you've completed your profile and uploaded your menu, your shop will automatically be sent for approval. 
	<br><br>
	For any help or advice, please contact <a href="mailto:support@koolbeans.co.uk" target="_blank" title="support@koolbeans.co.uk">support@koolbeans.co.uk</a><br>
	<br>
	To complete your profile ready for your first customers

	<a href="http://koolbeans.co.uk/" target="_blank" title="KoolBeans.co.uk">click here to log in</a><br>
	<br>
	from the<br>
	KoolBeans team
@stop
