        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6 col-sm-offset-2 col-md-offset-2 col-lg-offset-3" id="order-inner">
                <form action="{{ route('coffee-shop.order.store', ['coffeeShop' => $coffeeShop]) }}" method="post">
                    ...
                    <div class="col-xs-12 col-sm-4 btn-panel">
                        <a href="{{ route('coffee-shop.show', [ $coffeeShop->id ]) }}" class="btn btn-default proceed-to-checkout col-xs-12">Go Back</a>
                    </div>
                    <div class="col-xs-12 col-sm-8 btn-panel btn-panel-r">
