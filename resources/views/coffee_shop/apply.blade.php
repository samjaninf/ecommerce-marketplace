    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 text-center">
          ...
          <h4 style="border-bottom: 0px;">Full sales amount less fees paid directly to your bank account.<br />
Standard fees (6% 'KoolBeans' Commission on sales + 1.4% 'Stripe' Transaction Fee) No additional fees</h4>
        </div>
      </div>
    </div>
  </div>
