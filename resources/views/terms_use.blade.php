...
@section('content')
    ...
    <div class="container main-content-padded">
        ...
        <div class="row">
            <div class="col-xs-12">
                <h2>KOOLBEANS TERMS OF USE FOR WEBSITE AND APPLICATIONS</h2>
                <p>This page (together with the documents referred to on it) tells you the terms of use on which you may make use of our website koolbeans.co.uk (our "Site") or any application we make available via an app store or otherwise (our "Service"), whether as a guest or a registered user. Please read these terms of use carefully before you start to use or Site or our Service. By accessing our Site or by using our Service, you indicate that you accept these terms of use and that you agree to abide by them. If you do not agree to these terms of use, do not use access our Site or use our Service.</p>

                <h3>1. INFORMATION ABOUT US</h3>

                <p>KoolBeans.co.uk is a website operated by KoolBeans Global Limited (“we”, “us”, “our” or “KoolBeans”) incorporated and registered in England and Wales, whose registered office is at Ventura, Claremont Road, Kingsdown, Kent CT14 8BU, United Kingdom. Our company registration number is 08934484. KoolBeans is a business where Food and Drinks are prepared by independent Coffee Shops (the “Coffee Shops” or “They”) and served directly to you. KoolBeans acts purely as a referral agent and we hold no responsibility for the quality, timing or availability of the Drinks and Food provided by our Partner Coffee Shops. Please see our FAQ’s section for more help.</p>

                <h3>2. ACCESSING OUR SERVICE OR OUR SERVICES</h3>

                <p>Access to our Site and to our Service is permitted on a temporary basis, and we reserve the right to withdraw or amend access to our Site or our Service without notice (see below). We will not be liable if, for any reason, our Site or our Service is unavailable at any time or for any period. From time to time, we may restrict access to some parts our Site or our Service, or our entire Site or Service to users who have registered with us. You are responsible for maintaining the confidentially of your login details and any activities that occur under your account. If you have any concerns about your login details or think they have been misused, you should contact support@koolbeans.co.uk straight away to let us know. We can deactivate your account at any time.</p>
                ...
                <h3>8. RELIANCE ON INFORMATION POSTED</h3>
                ...
                <h3>9. OUR SITE AND OUR SERVICE CHANGE REGULARLY</h3>
                ...
                <h3>11. INFORMATION ABOUT YOU AND YOUR VISITS TO OUR SITE AND USE OF OUR SERVICE</h3>
                ...
                <h3>12. UPLOADING MATERIAL TO OUR SITE AND OUR SERVICE</h3>
                ...
                <h3>16. YOUR CONCERNS</h3>

                <p>If you have any concerns about material which appears on our Service, please contact support@koolbeans.co.uk</p>
            </div>
        </div>
    </div>
@stop
